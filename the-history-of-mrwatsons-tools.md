...
## 2026 Q1 – Tool Discovery & Help Overhaul

Q1 2026 marks a major usability upgrade across the entire MrWatson toolkit. The whole ecosystem has been refreshed with one clear goal:

**make the tools easier to discover, easier to install, and easier to use.**

{: .note}
Work in progress - this is history is still in the making

### 🔎 Better Discovery

[fmWorkMate] now has a completely refreshed look and a new tool discovery icon + menu, making it far simpler to explore and access the full range of [MrWatson's tools].

Finding and installing the right tools is no longer a treasure hunt — it’s structured, visible, and intentional.

The integrated news and help browser has also been tweaked:

![integrated news and help browser](assets/images/fmworkmate-integrated-browser.png)

### 📚 Proper Help — At Last

Every tool finally has the help it deserves.

The **App Help** menu now links directly to the central [help] documentation on [fmWorkMate.com], providing:

- Clear explanations
- Structured guidance
- Direct access to up-to-date documentation
